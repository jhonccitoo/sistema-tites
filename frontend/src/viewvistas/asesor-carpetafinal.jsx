...
function TarjetaTesista({ nombre, estadoInicial = '', fondo = '#c8facc' }) {
      ...
      <Card.Body className="d-flex align-items-center justify-content-between">
        ...
        <div className="form-control w-25"
          ...
          <div style={{ color: 'red', fontSize: 10, marginTop: 5 }}>
            ADVERTENCIA: Una vez enviado este documento se almacenará en la carpeta final y no se permite modificaciones futuras
          </div>
        </div>
      </Card.Body>
    </Card>
    ...
    <Container fluid>
      <Row>
        ...
        <Col md={10} className="p-4">
          ...
          <MensajeTesista nombre="PERCY QUISPE" mensaje="FALTA FIRMA DEL METODOLOGO" />

          <h4 className="mb-4">F.004</h4>
          <TarjetaTesista nombre="JOSE MARQUEZ" fondo="#6dfd79" />
          <MensajeTesista nombre="ADRIAN RETAMOZO" mensaje="FALTA FIRMA DE TESISTA Y METODOLOGO" fondo="#6dfd79" />

          <h4 className="mb-4">F.005</h4>
          <TarjetaTesista nombre="JADE CORDOVA" />
          <MensajeTesista nombre="JERZY CARRASCO" mensaje="FALTA FIRMA DEL TESISTA" />
        </Col>
      </Row>
    </Container>
  );
