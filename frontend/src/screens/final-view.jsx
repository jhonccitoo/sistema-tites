import React from 'react';
     ...
     return(
         <Container fluid>
             ...
             <Col style={{ width: '830px' }} className="bg-success text-white min-vh-100 p-3">
                 ...
                 <Button variant="light" className="text-start">Inicio</Button>
                 <Button variant="light" className="text-start">Revisión</Button>
                 <Button variant="light" className="text-start">Firmas</Button>
                 <Button variant="light" className="text-start active">Carpeta Final</Button>
                 </div>
 
                 <div className="mt-5 text-center">
                 <Button variant="outline-light" size="sm">Salir</Button>
                 </div>
             </Col>
 ...
 >
                 ...
                 <div style={{ color: 'red' }}>
                     ADVERTENCIA: Una vez enviado este documento se almacena en la carpeta final y no se puede modificar
                 </div>
             </div>
             </Card.Body>
           </Card>
